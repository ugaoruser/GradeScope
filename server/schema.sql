CREATE DATABASE IF NOT EXISTS grade_tracker CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE grade_tracker;
...
CREATE TABLE IF NOT EXISTS grade_categories (
  id INT AUTO_INCREMENT PRIMARY KEY,
  subject_id INT NOT NULL,
  name VARCHAR(100) NOT NULL, -- 'Performance Task', 'Written Works', 'Periodical Exam'
...
CREATE TABLE IF NOT EXISTS grade_items (
  ...
  title VARCHAR(255) NOT NULL,
  topic VARCHAR(255),
  item_type VARCHAR(100), -- 'Assessment', 'Summative', 'Quiz', etc.
  included_in_final BOOLEAN DEFAULT TRUE, -- included in final grade
...
INSERT IGNORE INTO roles (id, name) VALUES (1,'student'), (2,'teacher'), (3,'parent'), (4,'admin');
